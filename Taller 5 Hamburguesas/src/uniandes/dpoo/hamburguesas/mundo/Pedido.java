...
public class Pedido
{
    ...
    public String generarTextoFactura() {
        ...
        for (Producto item : productos) {
            if (item != null) {
                // Ajustar la cantidad de guiones con precisión entre el nombre y el precio
                String lineaProducto = String.format("%-10s %s %4d", item.getNombre(), "-----------", item.getPrecio());
